...
function aurora_scripts() {
	...
	wp_enqueue_style( 'aurora-google-font', 'http://fonts.googleapis.com/css?family=Roboto+Slab:400,300,700|Roboto:400,700,300,300italic,400italic,700italic' );

	wp_enqueue_script( 'aurora-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'aurora-scripts', get_template_directory_uri() . '/js/scripts.js', array( 'jquery' ), '20140925', true );

	wp_enqueue_script( 'aurora-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
